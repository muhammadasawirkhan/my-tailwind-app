...
export const Top_collection = () => {
    return (
        <>
            ...
            <div className='grid sm:grid-cols-2 md:grid-cols-3 py-[40px] px-[25px]'>
                ...
                <div className='relative '>
                    <div className='absolute left-[900px] -bottom-[230px]  z-[-1]'>
                    <img src={arrows} className='max-w-[405px] min-w-[405px]' alt="" />
                    </div>
                </div>
            </div>
