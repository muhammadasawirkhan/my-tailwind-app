    ...
    return (
        <>
            <div className="relative">
                ...
                <div className='w-full grid grid-cols-2 sm:grid-cols-2 2xl:grid-cols-4 gap-4 pt-[40px] 2xl:pl-[20px] 2xl:gap-0 '>
                    {/*card5 */}
                    <div className='relative min-w-[308px]'>
                        ...
                        <div className='absolute top-[98px] left-[18px] 2xl:top-[127px] 2xl:left-[23px]'>
                    ...
                    <div className='relative min-w-[308px]'>
                        ...
                        <div className='absolute top-[98px] left-[18px] 2xl:top-[135px] 2xl:left-[23px]'>
                    ...
                    <div className='relative min-w-[308px]'>
                        ...
                        <div className='absolute top-[98px] left-[18px] 2xl:top-[132px] 2xl:left-[23px]'>
